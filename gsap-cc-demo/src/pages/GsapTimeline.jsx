...
const GsapTimeline = () => {
  ...
  useGSAP(() => {
    timeline.to("#yellow-box", { duration: 2, x: 250, rotation: 360, ease: 'back.inOut', borderRadius: "100%" });

    timeline.to("#yellow-box", { duration: 2, y: 250, rotation: 360, ease: 'back.inOut', borderRadius: "100%", scale: 2 });

    timeline.to("#yellow-box", { duration: 2, x: 500, rotation: 360, ease: 'back.inOut', borderRadius: "8px", scale: 1 });
